export class Reimbursement {
    ...
    constructor(reimbId: number, reimbAccount: number, reimbSubmitted: Date, reimbResolved: Date, reimbDescription: string,
                reimbRecipt: string, reimbAuthor: number, reimbResolver: number, reimbStatusId: number, reimbTypeId: number) {

        this.reimbId = reimbId;
        this.reimbAccount = reimbAccount;
...
*/
    static from (obj: ReimbursementRow): Reimbursement {
        const reimbursement = new Reimbursement(
            obj.reimb_id, obj.reimb_account, obj.reimb_submitted, obj.reimb_resolved, obj.reimb_description,
